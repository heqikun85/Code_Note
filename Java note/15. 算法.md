...
|目录 | 目录 |
|----|----|
|[基本查找](#table1)|[二分查找](#table2)|
|[插值查找](#table3)|[斐波那契查找](#table4)|
|[分块查找](#table5)|[哈希查找](#table6)|
|[树表查找](#table7)||



## 1. <a id="table1">基本查找</a> 
...
在此不多做阐述。
 ...
 ![Snipaste_2022-09-05_21-36-50](./image/Snipaste_2022-09-05_21-36-50.png)

## 7. <a id="table7">树表查找</a>  
...
​        不同形态的二叉查找树如下图所示：
 ...
 ![20180226113852869](./image/20180226113852869.png) 
